...
export type TransportMode = 'transmilenio' | 'sitp' | 'bicicleta' | 'apie' | 'vehiculo';
...
export function TransportModeSelector({ activeMode, onSelect }: TransportModeSelectorProps) {
  return (
