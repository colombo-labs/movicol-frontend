    ...
    <>
      <header className="h-14 flex items-center justify-between px-5 border-b border-divider bg-background backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={toggle}
            className="w-9 h-9 rounded-xl flex items-center justify-center hover:bg-default-100 transition-all duration-200 text-default-500 hover:text-foreground active:scale-90"
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center hover:bg-primary/30 transition-all duration-200 active:scale-90"
            title="Mi perfil"
          >
