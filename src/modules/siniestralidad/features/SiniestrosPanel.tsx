...
export function SiniestrosPanel() {
  return (
    <div className="space-y-4">
      <p className="text-xs text-default-400">Zonas de mayor riesgo vial en Bogotá basadas en datos históricos de accidentes.</p>
      <GlassCard>
      ...
      <GlassCard>
        ...
        <p className="text-xs text-default-400">Sectores con alta concentración</p>
      </GlassCard>
      <GlassCard>
